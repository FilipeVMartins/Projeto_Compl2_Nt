### Descrição
Segundo projeto complementar de 'HTML, CSS e JavaScript' da Newtab Academy para uma página web com design responsivo, feito pensando em mobile first e utilizando HTML5, CSS3, Grid System do Bootstrap.
